...
use WCSBundle\Entity\PlaneModel;
...
class PlaneModelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $planeModels = $em->getRepository('WCSBundle:PlaneModel')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('WCSBundle\Form\PlaneModelType', $planeModel);
    ...
    {
        $deleteForm = $this->createDeleteForm($planeModel);
        $editForm = $this->createForm('WCSBundle\Form\PlaneModelType', $planeModel);
