...
class flightController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $flights = $em->getRepository('WCSBundle:flight')->findAll();
    ...
    {
        $flight = new Flight();
        $form = $this->createForm('WCSBundle\Form\flightType', $flight);
    ...
    {
        $deleteForm = $this->createDeleteForm($flight);
        $editForm = $this->createForm('WCSBundle\Form\flightType', $flight);
